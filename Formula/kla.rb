class Kla < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/d1ngd0/kla/releases/download/0.4.2/kla-aarch64-apple-darwin"
    sha256 "4a922a00bd6cdf58e8cbc997270c2cb68f0e2a1dfa0c48768fa1456214d290ed"
  else
    url "https://github.com/d1ngd0/kla/releases/download/0.4.2/kla-x86_64-apple-darwin"
